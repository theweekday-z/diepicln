    ...
    collisions() {
        ...
        squares.forEach((square, ind) => {
            ...
            bulletServer.getBullets().forEach((bullet, index) => {
                ...
                if (this.dist(bullet.x, bullet.y, square.x, square.y) > square.d/1.5) return;
            ...
            squares.forEach((sqre, index) => {
                if(ind === index) return;
                if (this.dist(square.x, square.y, sqre.x, sqre.y) > sqre.d) return;
            ...
            triangles.forEach(triangle => {
                if (this.dist(square.x, square.y, triangle.x, triangle.y) > triangle.d) return;
            ...
            pentagons.forEach(pentagon => {
                if (this.dist(square.x, square.y, pentagon.x, pentagon.y) > pentagon.d) return;
        ...
        triangles.forEach((triangle, ind) => {
            ...
            bulletServer.getBullets().forEach((bullet, index) => {
                if(bullet.dying) return;
                if (this.dist(bullet.x, bullet.y, triangle.x, triangle.y) > triangle.d) return;
            ...
            triangles.forEach((tringle, index) => {
                if(ind === index) return;
                if (this.dist(triangle.x, triangle.y, tringle.x, tringle.y) > tringle.d) return;
            ...
            pentagons.forEach(pentagon => {
                if (this.dist(triangle.x, triangle.y, pentagon.x, pentagon.y) > pentagon.d) return;
        ...
        pentagons.forEach((pentagon, ind) => {
            ...
            bulletServer.getBullets().forEach((bullet, index) => {
                if(bullet.dying) return;
                if (this.dist(bullet.x, bullet.y, pentagon.x, pentagon.y) > pentagon.d/1.5) return;
            ...
            pentagons.forEach((pentgon, index) => {
              if(ind === index) return;
              if (this.dist(pentagon.x, pentagon.y, pentgon.x, pentgon.y) > pentgon.d) return;
        ...
        playerServer.getPlayers().forEach(player => {
            ...
            bulletServer.getBullets().forEach((bullet, index) => {
                ...
                if(bullet.dying) return;
                if (this.dist(bullet.x, bullet.y, player.x, player.y) > player.d/1.5) return;
            ...
            playerServer.getPlayers().forEach(plyr => {
                ...
                if (this.dist(player.x, player.y, plyr.x, plyr.y) > plyr.d) return;
            ...
            squares.forEach(square => {
                if (this.dist(player.x, player.y, square.x, square.y) > square.d) return;
            ...
            triangles.forEach(triangle => {
                if (this.dist(player.x, player.y, triangle.x, triangle.y) > triangle.d) return;
            ...
            pentagons.forEach(pentagon => {
                if (this.dist(player.x, player.y, pentagon.x, pentagon.y) > pentagon.d) return;
        ...
        server.enemyServer.send({type: 'set', call: 'setTriangles', data: triangles});
        server.enemyServer.send({type: 'set', call: 'setPentagons', data: pentagons});
    }
};
